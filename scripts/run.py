...
from scripts.implementations import least_squares, logistic_regression_GD
...
if split_mode == 'default':
    ...
    loss_tr, w = method(y_tr, x_tr, gamma=gamma, max_iters=500, w0=None)
    ...
    for jet_group_tr, jet_group_te in zip(jet_groups_tr, jet_groups_te):
        ...
        loss_tr, w = method(_y_tr, _x_tr, gamma=gamma, max_iters=500, w0=None)
...
# create_csv_submission(ids_te, y_te_pred, f'{method}')
